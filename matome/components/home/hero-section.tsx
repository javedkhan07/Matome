...
export default function HeroSection() {
  return (
    ...
    >
      <div
        className="relative p-[1px] overflow-hidden rounded-full bg-linear-to-r from-rose200 via-rose-500
          to-rose-800 animate-gradient-x group"
      >
        <Badge
          variant={"secondary"}
          className="relative px-6 py-2 text-base font-medium bg-white rounded-full group-hover:bg-grey-50 
              transition-colors
            duration-200"
        >
      ...
      <Button
        ...
        className="text-white mt-6 text-base sm:text-lg lg:text-xl 
         rounded-full px-8 sm:px-10 lg:px-12 py-6 sm:py-7 lg:p-8
