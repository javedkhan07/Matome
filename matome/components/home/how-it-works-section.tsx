...
const steps: steps[] = [
  {
    ...
    description: "Simply drag and drop your PDF file here.",
  },
  {
    icon: <BrainCircuit size={64} strokeWidth={1.5} />,
    label: "AI Analysis",
    description: "Our AI will analyze the content of your document instantly.",
  },
  {
    icon: <FileOutput size={64} strokeWidth={1.5} />,
    label: "Get summary",
    description: "Retrieve clear and concise summary of your documents.",
  },
];
      ...
      <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 lg:pt-12">
        ...
        <div className="text-center mb-16">
          ...
          <h3 className="font-bold text-3xl max-w-2xl mx-auto">
            Transforms PDF into an easy-to-digest summary in three simple steps
          </h3>
        </div>
